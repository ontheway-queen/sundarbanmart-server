...
class AdminSearchController extends abstractController_1.default {
    constructor() {
        super();
        this.AdminPanelServices = new adminPanelServices_1.default();
        this.adminSearch = this.assyncWrapper.wrap((req, res) => __awaiter(this, void 0, void 0, function* () {
            const data = yield this.AdminPanelServices.AdminSearchService(req);
            if (data.success) {
